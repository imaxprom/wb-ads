...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { label: "Нижняя панель", value: "SplitPane: карточка товара + 5 вкладок. 27 столбцов по дням (до 90 дней). Drag, resize, hide" },
      { label: "Темы", value: "3 варианта: Violet, Arctic, Neon" },
      { label: "Настройки в БД", value: "13 ключей: theme, dashboard_period/offset, auto_sync_enabled/interval, col_widths/order/hidden, detail_col_widths/order/hidden, deep_sync_date, last_sync_time, active_tab" },
      ...
      { label: "Контекст", value: "PROJECT_CONTEXT.md + TODO.md + CLAUDE.md + KnowledgeBase (этот файл)" },
    ],
  },
  {
    id: "sync",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "settings", value: "Настройки (13 key-value, включая last_sync_time)" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Кампании", value: "5 активных + 19 на паузе + 308 завершённых" },
    ],
  },
];
